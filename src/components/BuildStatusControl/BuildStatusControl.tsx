						...
						{embed && this.state.embedModalOpen &&
							...
							>
								...
								<div className="embed-doc">
									Embed this code in a web page to show the live status of <strong>{this.getEmbedExplanation()}.</strong> <a href="/docs/setup-build-status-image">Read the docs for more details.</a>
								</div>
								<div>
									Format:&nbsp;
